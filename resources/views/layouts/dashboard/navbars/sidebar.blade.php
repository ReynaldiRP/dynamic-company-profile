    ...
    <aside
        ...
        <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
            <ul class="flex flex-col pl-0 mb-0">
                ...
                {{-- <x-sidebar-menu-item route="dashboard" label="Dashboard"
                    currentRoute="{{ request()->route()->getName() }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="12px" heigth="12px"
                        viewBox="0 0 512 512">
                        <path class="{{ request()->is('Dashboard') ? 'fill-white' : '' }}"
                ...
                <x-sidebar-menu-item route="Profil Perusahaan" label="Profil Perusahaan"
                    currentRoute="{{ request()->route()->getName() }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="12px" heigth="12px" viewBox="0 0 384 512">
                        <path class="{{ request()->is('CompanyProfile') ? 'fill-white' : '' }}"
                ...
                <x-sidebar-menu-item route="Service Perusahaan" label="Service Perusahaan"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="14px" height="14px"
                        ...
                        <path class="{{ request()->is('CompanyService') ? 'fill-white' : '' }}"
                ...
                <x-sidebar-menu-item route="Pertanyaan Perusahaan" label="FAQ Perusahaan"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="14px" height="14px" viewBox="0 0 512 512">
                        <path class="{{ request()->is('CompanyFaq') ? 'fill-white' : '' }}"
                ...
                <x-sidebar-menu-item route="Proyek Perusahaan" label="Proyek Perusahaan"
                    currentRoute="{{ request()->route()->getName() }}">
                    <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                        viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        <path class="{{ request()->is('CompanyProject') ? 'fill-white' : '' }}"
                            d="M184 48H328c4.4 0 8 3.6 8 8V96H176V56c0-4.4 3.6-8 8-8zm-56 8V96H64C28.7 96 0 124.7 0 160v96H192 320 512V160c0-35.3-28.7-64-64-64H384V56c0-30.9-25.1-56-56-56H184c-30.9 0-56 25.1-56 56zM512 288H320v32c0 17.7-14.3 32-32 32H224c-17.7 0-32-14.3-32-32V288H0V416c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V288z" />
                    </svg>
                </x-sidebar-menu-item>

                <x-sidebar-menu-item route="Team Perusahaan" label="Teams Perusahaan"
                    currentRoute="{{ request()->route()->getName() }}">
                    <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                        viewBox="0 0 640 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        <path class="{{ request()->is('CompanyTeam') ? 'fill-white' : '' }}"
