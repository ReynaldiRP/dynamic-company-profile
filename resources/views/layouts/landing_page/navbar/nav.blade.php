    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://flowbite.com/" class="flex items-center">
            @foreach ($companyProfile as $data)
                ...
                <span
                    class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">{{ $data->name }}</span>
            @endforeach
        </a>
        <div class="flex md:order-2">
            <div class="flex gap-4">
                ...
                <a href=""
                    class="text-white bg-transparent hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-transparent dark:hover:bg-blue-700 dark:focus:ring-blue-800">Daftar</a>
            </div>
