        ...
        <div class="flex flex-col gap-4">
            ...
            <section class="h-full flex flex-col  bg-white shadow-soft-lg rounded-lg font-poppins">
                <form action="" method="post">
                    ...
                    <div class="flex flex-col p-4 gap-1" id="input-teams-project">
                        <label for="teams-project" class="text-base text-slate-600 font-semibold">Gambar Anggota
                            Team</label>
                        <input type="file" id="teams-project" name="teams-project" placeholder="Gambar Anggota Team"
                            class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-fuchsia-300 focus:outline-none">
                    </div>
